...
public abstract class ApoException extends Exception {

    protected ApoException() {
        super();
    }

    protected ApoException(String message) {
        super(message);
    }

    protected ApoException(String message, Throwable cause) {
        super(message, cause);
    }

    protected ApoException(Throwable cause) {
        super(cause);
    }

    public static abstract class ValidationException extends ApoException {
    ...
    public static final class ApoIOException extends IOException {

        public ApoIOException(String message) {
            super(message);
        }

        public ApoIOException(String message, Throwable cause) {
            super(message, cause);
        }
