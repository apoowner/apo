...
import apo.Apo;
import apo.env.service.ApoService_ServiceManagement;
...
public class ManifestGenerator {
    ...
    public static void main(String[] args) {
        ...
        manifestGenerator.generate("./resource/apo.manifest.mf", Apo.class.getCanonicalName(), "./lib");
        String serviceClassName = ApoService_ServiceManagement.class.getCanonicalName();
        serviceClassName = serviceClassName.substring(0, serviceClassName.length() - "_ServiceManagement".length());
        manifestGenerator.generate("./resource/aposervice.manifest.mf", serviceClassName, "./lib");
    }
