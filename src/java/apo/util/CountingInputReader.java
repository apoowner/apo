...
import apo.ApoException.ApoIOException;
...
public class CountingInputReader extends FilterReader {
     ...
     * @throws  ApoIOException      Maximum count exceeded
     */
    private void incCount(long c) throws ApoIOException {
        count += c;
        if (count > limit)
            throw new ApoIOException("Maximum size exceeded: " + count);
    }
}
