...
/**
 * Handle logging for the Apo node server
 */
public final class Logger {
     ...
     * The apo/conf/logging-default.properties and apo/conf/logging.properties configuration
    ...
    static {
        ...
        System.setProperty("java.util.logging.manager", "apo.util.ApoLogManager");
        if (!(LogManager.getLogManager() instanceof ApoLogManager)) {
            System.setProperty("java.util.logging.manager",
                    (oldManager != null ? oldManager : "java.util.logging.LogManager"));
        }
        if (! Boolean.getBoolean("apo.doNotConfigureLogging")) {
            try {
                Properties loggingProperties = new Properties();
                Apo.loadProperties(loggingProperties, "logging-default.properties", true);
                Apo.loadProperties(loggingProperties, "logging.properties", false);
                Apo.updateLogFileHandler(loggingProperties);
        ...
        log = org.slf4j.LoggerFactory.getLogger(apo.Apo.class);
        enableStackTraces = Apo.getBooleanProperty("apo.enableStackTraces");
        enableLogTraceback = Apo.getBooleanProperty("apo.enableLogTraceback");
    ...
    public static void shutdown() {
        if (LogManager.getLogManager() instanceof ApoLogManager) {
            ((ApoLogManager) LogManager.getLogManager()).apoShutdown();
        }
    }
