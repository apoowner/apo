...
/**
 * Java LogManager extension for use with Apo
 */
public class ApoLogManager extends LogManager {

    /** Logging reconfiguration in progress */
    private volatile boolean loggingReconfiguration = false;

    /**
     * Create the Apo log manager
     *
     ...
     * done terminating the Apo processes.
     */
    public ApoLogManager() {
        super();
    }
     ...
     * This allows us to continue to use logging facilities during Apo shutdown.
     */
    @Override
    public void reset() {
    ...
    /**
     * Apo shutdown is now complete, so call LogManager.reset() to terminate
     * the log handlers.
     */
    void apoShutdown() {
        super.reset();
