...
public interface Transaction {
    ...
    interface Builder {
        ...
        Transaction build() throws ApoException.NotValidException;

        Transaction build(String secretPhrase) throws ApoException.NotValidException;
    ...
    void validate() throws ApoException.ValidationException;
