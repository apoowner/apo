...
public final class Constants {
    ...
    public static final int NEW_FEE_CALCULATION_BLOCK = 0; //suse 28/06/2017
    public static final String COIN_NAME = "APO";
    public static final boolean isTestnet = Apo.getBooleanProperty("apo.isTestnet");
    public static final boolean isOffline = Apo.getBooleanProperty("apo.isOffline");
    public static final boolean isLightClient = Apo.getBooleanProperty("apo.isLightClient");

    public static final int MAX_NUMBER_OF_TRANSACTIONS = 255;
    public static final int MIN_TRANSACTION_SIZE = 176;
    public static final int MAX_PAYLOAD_LENGTH = MAX_NUMBER_OF_TRANSACTIONS * MIN_TRANSACTION_SIZE;
    public static final long MAX_BALANCE_APO = 10000000000L;
    public static final long ONE_APO = 100000000;
    //public static final long TRANSACTION_FEE = ONE_APO / Apo.getIntProperty("apo.reductorFee", 1); //suse
    public static final long REDUCTOR_FEE = Apo.getIntProperty("apo.reductorFee", 1); //suse
    public static final long MAX_BALANCE_NQT =  MAX_BALANCE_APO * ONE_APO;
    public static final long INITIAL_BASE_TARGET = 153722867;
    public static final long MAX_BASE_TARGET =  MAX_BALANCE_APO * INITIAL_BASE_TARGET;
    ...
    public static final int MAX_ROLLBACK = Math.max(Apo.getIntProperty("apo.maxRollback"), 720);
    //public static final int GUARANTEED_BALANCE_CONFIRMATIONS = isTestnet ? Apo.getIntProperty("apo.testnetGuaranteedBalanceConfirmations", 1440) : 1440;
    public static final int GUARANTEED_BALANCE_CONFIRMATIONS = isTestnet ? Apo.getIntProperty("apo.testnetGuaranteedBalanceConfirmations", 1440) : 1440;
    public static final int LEASING_DELAY = isTestnet ? Apo.getIntProperty("apo.testnetLeasingDelay", 1440) : 1440;
    //suse public static final int MAX_LEASING_PERIOD = 65535;
    public static final int MAX_LEASING_PERIOD = 65535;
    public static final long MIN_FORGING_BALANCE_NQT = 1000000 * ONE_APO;

    public static final int MAX_TIMEDRIFT = 15; // allow up to 15 s clock difference
    public static final int FORGING_DELAY = Apo.getIntProperty("apo.forgingDelay");
    public static final int FORGING_SPEEDUP = Apo.getIntProperty("apo.forgingSpeedup");
		public static final int BATCH_COMMIT_SIZE = Apo.getIntProperty("wcg.batchCommitSize", Integer.MAX_VALUE);
    ...
    static {
        int maxPrunableLifetime = Apo.getIntProperty("apo.maxPrunableLifetime");
        ENABLE_PRUNING = maxPrunableLifetime >= 0;
        MAX_PRUNABLE_LIFETIME = ENABLE_PRUNING ? Math.max(maxPrunableLifetime, MIN_PRUNABLE_LIFETIME) : Integer.MAX_VALUE;
    }
    public static final boolean INCLUDE_EXPIRED_PRUNABLE = Apo.getBooleanProperty("apo.includeExpiredPrunable");
    ...
    public static final long MAX_ASSET_QUANTITY_QNT = 10000000000L * 100000000L;
    ...
    static final long UNCONFIRMED_POOL_DEPOSIT_NQT = (isTestnet ? 50 : 100) * ONE_APO;
    public static final long SHUFFLING_DEPOSIT_NQT = (isTestnet ? 7 : 1000) * ONE_APO;

    public static final boolean correctInvalidFees = Apo.getBooleanProperty("apo.correctInvalidFees");
    ...
    public static final String SECRETPHRASE_PREFIX = "apo";

    public static final long COINBASE_PERIOD = 1000000L;
    public static final long COINBASE_MAX = 6000000000L;
    public static final float COINBASE_INITIAL = 1000.0f;
    public static final float COINBASE_FACTOR = 0.9f;

    public static final long ISSUE_ASSET_FEE = 10000;
