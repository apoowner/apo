...
import static apo.user.JSONResponses.LOCK_ACCOUNT;
...
public final class UnlockAccount extends UserServlet.UserRequestHandler {
    ...
    JSONStreamAware processRequest(HttpServletRequest req, User user) throws IOException {
        ...
        if (account == null) {
            ...
            try (DbIterator<? extends Transaction> transactions = Apo.getTransactionProcessor().getAllUnconfirmedTransactions()) {
            ...
            int blockchainHeight = Apo.getBlockchain().getLastBlock().getHeight();
            try (DbIterator<? extends Block> blockIterator = Apo.getBlockchain().getBlocks(accountId, 0)) {
            ...
            try (DbIterator<? extends Transaction> transactionIterator = Apo.getBlockchain().getTransactions(accountId, (byte) -1, (byte) -1, 0, false)) {
