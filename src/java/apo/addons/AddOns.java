...
import apo.Apo;
import apo.http.APIServlet;
import apo.http.APITag;
...
public final class AddOns {
    ...
    static {
        ...
        Apo.getStringListProperty("apo.addOns").forEach(addOn -> {
            try {
        ...
        if (!addOns.isEmpty() && !Apo.getBooleanProperty("apo.disableSecurityPolicy")) {
            System.setProperty("java.security.policy", Apo.isDesktopApplicationEnabled() ? "apodesktop.policy" : "apo.policy");
