...
import static apo.http.JSONResponses.MONITOR_ALREADY_STARTED;
import static apo.http.JSONResponses.UNKNOWN_ACCOUNT;
import static apo.http.JSONResponses.incorrect;

/**
 * Start a funding monitor
 * <p>
 * A funding monitor will transfer APO, ASSET or CURRENCY from the funding account
 ...
 * <p>
 * APO amounts are specified with 8 decimal places.  Asset and Currency decimal places
...
public final class StartFundingMonitor extends APIServlet.APIRequestHandler {
     ...
     * @throws  ApoException        Unable to process request
     */
    @Override
