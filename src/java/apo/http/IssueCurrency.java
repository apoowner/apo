...
/**
 * Issue a currency on the APO blockchain
 * <p>
 * A currency is the basic block of the APO Monetary System it can be exchanged with APO, transferred between accounts,
 ...
 * For {@link apo.CurrencyType#RESERVABLE} currency
 * <li>minReservePerUnitNQT - the minimum APO value per unit to allow the currency to become active
 * For {@link apo.CurrencyType#RESERVABLE} currency
 ...
 * For {@link apo.CurrencyType#MINTABLE} currency
 * <li>maxDifficulty - for mint-able currency, the exponent of the final difficulty.
 * For {@link apo.CurrencyType#MINTABLE} currency
 * <li>algorithm - the hashing {@link apo.crypto.HashFunction algorithm} used for minting.
 * For {@link apo.CurrencyType#MINTABLE} currency
 * </ul>
 * <p>
 * Constraints
 * <ul>
 * <li>A given currency can not be neither {@link apo.CurrencyType#EXCHANGEABLE} nor {@link apo.CurrencyType#CLAIMABLE}.<br>
 * <li>A {@link apo.CurrencyType#RESERVABLE} currency becomes active once the blockchain height reaches the currency issuance height.<br>
 ...
 * When a {@link apo.CurrencyType#RESERVABLE} becomes active, in case it is {@link apo.CurrencyType#CLAIMABLE} the APO used for
 * reserving the currency are locked until they are claimed back.
 * When a {@link apo.CurrencyType#RESERVABLE} becomes active, in case it is non {@link apo.CurrencyType#CLAIMABLE} the APO used for
 * reserving the currency are sent to the issuer account as crowd funding.
 * <li>When issuing a {@link apo.CurrencyType#MINTABLE} currency, the number of units per {@link apo.http.CurrencyMint} cannot exceed 0.01% of the
 ...
 * difficulty increases linearly with the number units minted per {@link apo.http.CurrencyMint}<br>
 * </ul>
 *
 * @see apo.CurrencyType
 * @see apo.crypto.HashFunction
 */
