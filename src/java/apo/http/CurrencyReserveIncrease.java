...
/**
 * Increase the value of currency units by paying APO
 * <p>
 * Parameters
 * <ul>
 ...
 * Constraints
 * <p>
 * This API is allowed only when the currency is {@link apo.CurrencyType#RESERVABLE} and is not yet active.
 * <p>
 ...
 * The list of founders and their NQT investment can be obtained using the {@link apo.http.GetCurrencyFounders} API.
 */
