 ...
 * account ledger tracks all account changes as determined by the apo.ledgerAccounts,
 * apo.ledgerLogUnconfirmed and apo.ledgerTrimKeep properties.
 * </p>
 * <table>
 ...
 *           The administrator password is required if more than apo.maxAPIRecords entries are to be searched.
 *       </td>
 *     </tr>
 *     <tr>
 *       <td>event</td>
 ...
 *           The maximum number of entries returned is limited by the apo.maxAPIRecords property
 ...
 *     <tr>
 *       <td>APO_BALANCE</td>
 *       <td>Change in the APO balance for the account.  There is no 'holding'.</td>
 *     </tr>
 *     <tr>
 ...
 *     </tr>
 *     <tr>
 *       <td>UNCONFIRMED_APO_BALANCE</td>
 *       <td>Change in the unconfirmed APO balance for the account.  There is no 'holding'.</td>
 *     </tr>
 *   </tbody>
 * </table>
 */
public class GetAccountLedger extends APIServlet.APIRequestHandler {
     ...
     * @return                      API response
     * @throws  ApoException        Invalid request
     */
    @Override
