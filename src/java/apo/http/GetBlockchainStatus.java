...
public final class GetBlockchainStatus extends APIServlet.APIRequestHandler {
    ...
    protected JSONObject processRequest(HttpServletRequest req) {
        ...
        response.put("application", Apo.APPLICATION);
        response.put("version", Apo.VERSION);
        response.put("time", Apo.getEpochTime());
        ...
        response.put("currentMinRollbackHeight", Apo.getBlockchainProcessor().getMinRollbackHeight());
