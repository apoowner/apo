...
public final class ShufflingCreate extends CreateTransaction {
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) throws ApoException {
        ...
        if (holdingType == HoldingType.APO && amount < Constants.SHUFFLING_DEPOSIT_NQT) {
            return JSONResponses.incorrect("amount", "Minimum shuffling amount is " + Constants.SHUFFLING_DEPOSIT_NQT / Constants.ONE_APO + " " + Constants.COIN_NAME + "");
        }
