...
import apo.http.EventListener.PendingEvent;
 ...
 * apo.apiEventTimeout will be used if no timeout value is specified or
 * if the requested timeout is greater than apo.apiEventTimeout.</li>
 * </ul>
 *
