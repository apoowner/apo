...
import static apo.http.JSONResponses.NO_MESSAGE;
import static apo.http.JSONResponses.PRUNED_TRANSACTION;
...
public final class ReadMessage extends APIServlet.APIRequestHandler {
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) throws ParameterException {
        ...
        Transaction transaction = Apo.getBlockchain().getTransaction(transactionId);
        if (transaction == null) {
