...
var NRS = (function(NRS, $) {
	var index = 0;
	var bundles = [
		{alias: "nrsVersion", status: "release", prefix: "apo-client-", ext: "zip"},
		{alias: "nrsBetaVersion", status: "beta", prefix: "apo-client-", ext: "zip"},
		{alias: "nrsVersionWin", status: "release", prefix: "apo-client-", ext: "exe"},
		{alias: "nrsBetaVersionWin", status: "beta", prefix: "apo-client-", ext: "exe"},
		{alias: "nrsVersionMac", status: "release", prefix: "apo-installer-", ext: "dmg"},
		{alias: "nrsBetaVersionMac", status: "beta", prefix: "apo-installer-", ext: "dmg"},
		{alias: "nrsVersionLinux", status: "release", prefix: "apo-client-", ext: "sh"},
		{alias: "nrsBetaVersionLinux", status: "beta", prefix: "apo-client-", ext: "sh"}
	];
	...
	NRS.downloadClientUpdate = function(status, ext) {
        ...
        var fileurl = "https://bitbucket.org/JeanLucPicard/apo/downloads/" + filename;
