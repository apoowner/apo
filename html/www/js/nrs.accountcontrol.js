...
var NRS = (function(NRS, $) {
	...
	$("#set_mandatory_approval_modal").on("show.bs.modal", function(e) {
		...
		var context = {
			...
			inputName: "controlQuorumAPO",
			addonText: "APO",
			addonI18n: "apo_unit"
		}
		var $elems = NRS.initModalUIElement($modal, '.phasing_only_amount_apo', 'simple_input_with_addon_modal_ui_element', context);
		...
		context['inputName'] = 'controlMinBalanceAPO';
		context['addonText'] = 'APO';
		context['addonI18n'] = 'apo_unit';
		var $elems = NRS.initModalUIElement($modal, '.phasing_only_min_balance_apo', 'simple_input_with_addon_modal_ui_element', context);
		$elems.find('input').prop("disabled", true);
		$elems.hide();
