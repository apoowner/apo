...
var NRS = (function (NRS, $) {
    NRS.constants = {
        ...
        //'MAX_UNSIGNED_SHORT_JAVA': 9437040,
        ...
        'UNKNOWN': 'unknown',
        //suse 'LAST_KNOWN_BLOCK': { id: "14216614632643561569", height: "12888" },
        'LAST_KNOWN_BLOCK': { id: "7575241065488598701", height: "0" },
        'LAST_KNOWN_TESTNET_BLOCK': { id: "10261376443915405620", height: "1051000" },
        'SECRETPHRASE_PREFIX': 'apo'
    };
    ...
    NRS.loadServerConstants = function(resolve) {
        ...
        if (NRS.isMobileApp()) {
            // console.log("NRS.isMobileApp done loading server constants");
            jQuery.ajaxSetup({ async: false });
            $.getScript("js/data/constants.js" );
            jQuery.ajaxSetup({async: true});
            processConstants(NRS.constants.SERVER);
        } else {
            // console.log("no NRS.isMobileApp done loading server constants");
