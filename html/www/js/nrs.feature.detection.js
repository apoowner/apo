...
var NRS = (function (NRS) {
    ...
    /*var remoteNode = new RemoteNode({
        address: NRS.defaultServer,
        announcedAddress: NRS.defaultServer,
        apiPort: NRS.defaultApiPort,
        isSsl: NRS.defaultIsSsl
    });*/
    ///suse
    ...
    NRS.isMobileApp = function () {
		// console.log("NRS.isMobileApp = "+(isMobileDevice || NRS.mobileSettings.is_simulate_app));
    ...
    NRS.getShapeShiftUrl = function() {
        if (isDesktopApplication) {
            return location.origin + "/apo-exchange/";
        } else {
