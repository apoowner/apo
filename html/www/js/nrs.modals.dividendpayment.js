...
var NRS = (function(NRS, $, undefined) {
    ...
    $("#dividend_payment_amount_per_share, #dividend_payment_height").on("blur", function() {
        ...
        var amountAPOPerShare = $modal.find("#dividend_payment_amount_per_share").val();
        ...
        if (amountAPOPerShare && /^\d+$/.test(height)) {
            NRS.getAssetAccounts(NRS.getCurrentAsset().asset, height,
                function (response) {
                    ...
                    var priceNQT = new BigInteger(NRS.calculatePricePerWholeQNT(NRS.convertToNQT(amountAPOPerShare), NRS.getCurrentAsset().decimals));
                    var totalAPO = NRS.calculateOrderTotal(totalQuantityQNT, priceNQT);
