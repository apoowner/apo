	...
	NRS.pages.news = function() {
      ...
      var settingsReddit = {
         ...
         "filter": function(entry, tokens) {
            return tokens.title.indexOf("Donations toward") == -1 && tokens.title.indexOf("APO tipping bot has arrived") == -1
         },
         "ssl": ssl
      };

      $("#apoforum_news").rss("http://forum.r6s6.com/index.php?action=.xml;type=rss", settings, NRS.newsLoaded);
      //$("#reddit_news").rss("http://www.reddit.com/r/APO/.rss", settingsReddit, NRS.newsLoaded);
      //$("#apocoin_blogspot_news").rss("http://apocoin.blogspot.com/feeds/posts/default", settings, NRS.newsLoaded);
      //$("#apoer_news").rss("http://apoer.org/feed/", settings, NRS.newsLoaded);
		NRS.pageLoaded();
	};
