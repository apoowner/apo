...
var NRS = (function(NRS, $) {
	...
	NRS.defaultModules = {
		...
		"shuffling": false,
		"messages": true,
		"transactions_notification": false,
		"aliases": false,
		"plugins": false,
		'issue_asset': true,
		'add_asset_button': false
	};
	
	NRS.disableTransacionType = [];

	/* suse 28/04/2017
	 * No more required
	 * The list of existing asset will be retrived in NRS.pages.asset_exchange
	 * via NRS.sendRequest("getAssetIds"...) call
	 */
	NRS.defaultAsset = {
			/*"USD": "1253407339295328136", //USD
			"RMB": "1973590044918501785", //RMB
			"BTC": "16417839782151841262" //BTC*/
	};

	// typeDict=  nrs.transactions.js:668:4
	// Object { title: "Payment", i18nKeyTitle: "payment", iconHTML: "<i class='ion-calculator'></i>", subTypes: Object[1], notificationCount: 0 }  nrs.transactions.js:669:4
	// typeDict=  nrs.transactions.js:668:4
	//
	// messaging_voting_aliases -> polls
	// asset_exchange -> asset_exchange
	// marketplace -> marketplace
	//
	// Object { title: "Account Control", i18nKeyTitle: "account_control", iconHTML: "<i class="ion-locked"></i>", subTypes: Object[2], notificationCount: 0 }  nrs.transactions.js:669:4
	// typeDict=  nrs.transactions.js:668:4
	// Object { title: "Monetary System", i18nKeyTitle: "monetary_system", iconHTML: "<i class="fa fa-bank"></i>", subTypes: Object[9], notificationCount: 0 }  nrs.transactions.js:669:4
	// typeDict=  nrs.transactions.js:668:4
	// Object { title: "Data Cloud", i18nKeyTitle: "tagged_data", iconHTML: "<i class="fa fa-dashboard"></i>", subTypes: Object[2], notificationCount: 0 }  nrs.transactions.js:669:4
	// typeDict=  nrs.transactions.js:668:4
	// Object { title: "Shuffling", i18nKeyTitle: "shuffling", iconHTML: "<i class="fa fa-random"></i>", subTypes: Object[6], notificationCount: 0 }
	...
	NRS.defaultSettings = {
		...
		"items_page": "15",
		"admin_password": "",
        "exchange_url": "https://apo-exchange.domain.ext/",
	...
	NRS.pages.settings = function() {
		...
		for (var key in NRS.settings) {
            ...
            if (/_warning/i.test(key) && key != "asset_transfer_warning" && key != "currency_transfer_warning") {
				if (setting.length) {
					setting.val(NRS.convertToAPO(NRS.settings[key]));
				}
	...
	NRS.updateSettings = function(key, value) {
		if (key) {
			console.log('updateSettings: key='+key+' - value='+value);
