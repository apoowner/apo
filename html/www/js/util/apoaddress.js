...
/*
    APO address class, extended version (with error guessing).

    Version: 1.0, license: Public Domain, coder: ApoChg (admin@apochg.com).
*/
...
function ApoAddress() {
	...
	this.set = function(adr, allow_accounts) {
		...
		if (adr.indexOf('APO-') == 0) adr = adr.substr(4);
